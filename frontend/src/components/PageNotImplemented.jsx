const NotFoundPage = () => {
    return (
        <main className="flex flex-col flex-grow items-center justify-center px-4 mt-12 ">
            <h2 className="text-4xl font-bold text-center mb-12 text-white">Page en construction</h2>
            <p className="max-w-xl text-center text-white">Il semblerait que la page que vous souhaitez atteindre ne soit pas encore disponible.</p>
