...
const FloatingIcon = ({ IconComponent, className, size, position, animationClass }: FloatingIconProps) => {
    return (
        <div
    ...
    const icons: FloatingIconConfig[] = [
        {
            ...
            animation: 'animate-float-slow animate-spin-slow'
        },
        {
            Icon: SiValorant,
            size: 'w-20 h-20',
            position: { top: '20%', right: '15%' },
            animation: 'animate-float-medium animate-spin-medium'
        },
        {
            Icon: TbBrandFortnite,
            size: 'w-14 h-14',
            position: { bottom: '15%', left: '20%' },
            animation: 'animate-float-fast animate-spin-fast'
        },
        {
            Icon: SiCounterstrike,
            size: 'w-18 h-18',
            position: { top: '50%', left: '5%' },
            animation: 'animate-float-slow animate-spin-medium'
        },
        {
            Icon: SiNintendo3Ds,
            size: 'w-16 h-16',
            position: { bottom: '10%', right: '10%' },
            animation: 'animate-float-medium animate-spin-slow'
        },
        {
