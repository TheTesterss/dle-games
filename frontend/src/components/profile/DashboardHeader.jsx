...
const DashboardHeader = ({ navigateTo }) => {
    ...
    return (
        <header
            className={`relative py-8 px-4 overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 text-center shadow-2xl border border-gray-700 flex flex-col md:flex-row items-center justify-between`}
            style={{
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center md:items-start mb-4 md:mb-0">
                <h1 className="text-5xl md:text-6xl font-black text-blue-700 drop-shadow-lg leading-none">DLE</h1>
            ...
            <div className="relative z-10 flex items-center space-x-4 mt-4 md:mt-0">
                {currentUser && (
                    <>
                        ...
                        />
                        <span className="text-xl font-semibold text-white">{currentUser.name}</span>
                    </>
                )}
            </div>
        </header>
