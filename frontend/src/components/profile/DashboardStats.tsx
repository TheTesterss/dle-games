    ...
    return (
        <div className="p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <StatCard title="Adversaire le plus joué" value={stats.mostPlayedOpponent || 'Aucun'} />
            </div>
...
const StatCard: React.FC<StatCardProps> = ({ title, value, color = 'text-blue-300' }) => (
    <div
