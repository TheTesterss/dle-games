import FloatingIcons from "src/components/subcomponents/FloatingIcons";
...
>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full">
                <h1 className="text-6xl md:text-8xl font-black text-blue-700 drop-shadow-lg leading-none mb-2">
                    DLE
                </h1>
